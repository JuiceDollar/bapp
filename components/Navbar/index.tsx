	...
	return (
		<div className="fixed top-0 left-0 right-0 z-20">
			<div className="flex justify-center">
				<header className="flex w-full max-w-[1440px] h-16 px-spacing-10 bg-white border-b border-menu-separator bg-menu-back backdrop-blur justify-between items-center shrink-0">
