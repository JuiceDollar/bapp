...
export default function CoverageBridges() {
	...
	const bridges = allBridges.filter((b) => b.minted >= ONE_JUSD);

	const headers = [t("coverage.stablecoin"), t("coverage.minted"), t("coverage.limit"), t("coverage.utilization"), t("coverage.status")];
								...
								<div>
									<span
										className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${
											bridge.isExpired ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"
										}`}
									>
