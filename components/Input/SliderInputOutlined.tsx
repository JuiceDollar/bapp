...
export function SliderInputOutlined({ value, onChange, min, max, decimals, isError, errorMessage, usdPrice, disabled }: SliderInputOutlinedProps) {
	...
	return (
		<div className="self-stretch relative pb-1.5">
			<div className={`self-stretch p-2 rounded-xl border-2 border-transparent relative flex-col justify-center items-start gap-2 before:absolute before:inset-0 before:rounded-xl before:border before:pointer-events-none before:transition-colors before:duration-200 ${
				disabled 
