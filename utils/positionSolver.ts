...
export function solveManage(
  ...
  if (target === 'EXPIRATION') {
    return {
      ...
      deltaCollateral: 0n, deltaDebt: 0n, deltaLiqPrice: 0n,
  ...
  if (currentDebt === 0n || currentDebt < 1000n) {
    return {
      next: pos, deltaCollateral: 0n, deltaDebt: 0n, deltaLiqPrice: 0n, txPlan: [],
      isValid: false,
  ...
  try {
    ...
    return {
      ...
      deltaCollateral, deltaDebt, deltaLiqPrice: newLiqPrice - currentLiqPrice, txPlan,
      isValid: true,
    };
  } catch (error) {
    return {
...
export function getStrategiesForTarget(target: Target, isIncrease: boolean) {
  ...
  const strategies = {
    COLLATERAL: {
      increase: [
        { strategy: 'KEEP_LOAN' as Strategy, label: 'Keep loan constant', description: 'Add collateral only', consequence: 'Lower liquidation price (safer)' },
        { strategy: 'KEEP_LIQ_PRICE' as Strategy, label: 'Keep price constant', description: 'Add collateral & borrow more', consequence: 'Loan increases' },
      ],
      decrease: [
        { strategy: 'KEEP_LOAN' as Strategy, label: 'Keep loan constant', description: 'Remove collateral only', consequence: 'Higher liquidation price (riskier)' },
        { strategy: 'KEEP_LIQ_PRICE' as Strategy, label: 'Keep price constant', description: 'Remove collateral & repay', consequence: 'Loan decreases' },
      ],
    },
    LIQ_PRICE: {
      increase: [
        { strategy: 'KEEP_LOAN' as Strategy, label: 'Keep loan constant', description: 'Remove collateral', consequence: 'Collateral decreases' },
        { strategy: 'KEEP_COLLATERAL' as Strategy, label: 'Keep collateral constant', description: 'Borrow more', consequence: 'Loan increases' },
      ],
      decrease: [
        { strategy: 'KEEP_LOAN' as Strategy, label: 'Keep loan constant', description: 'Add collateral', consequence: 'Collateral increases' },
        { strategy: 'KEEP_COLLATERAL' as Strategy, label: 'Keep collateral constant', description: 'Repay loan', consequence: 'Loan decreases' },
      ],
    },
    LOAN: {
      increase: [
        { strategy: 'KEEP_LIQ_PRICE' as Strategy, label: 'Keep price constant', description: 'Add collateral', consequence: 'Collateral increases' },
        { strategy: 'KEEP_COLLATERAL' as Strategy, label: 'Keep collateral constant', description: 'Borrow more', consequence: 'Higher liquidation price (riskier)' },
      ],
      decrease: [
        { strategy: 'KEEP_LIQ_PRICE' as Strategy, label: 'Keep price constant', description: 'Remove collateral', consequence: 'Collateral decreases' },
        { strategy: 'KEEP_COLLATERAL' as Strategy, label: 'Keep collateral constant', description: 'Repay loan', consequence: 'Lower liquidation price (safer)' },
      ],
    },
  };
