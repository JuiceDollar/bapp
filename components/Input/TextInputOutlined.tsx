...
export const TextInputOutlined = ({ className, placeholder, value, onChange }: TextInputOutlinedProps) => {
	...
	return (
		<div
			className={`flex w-full max-w-[504px] p-2 px-3 sm:p-3 rounded-xl border-2 border-transparent relative flex-col justify-center items-start gap-2 before:absolute before:inset-0 before:rounded-xl before:border before:pointer-events-none before:transition-colors before:duration-200 ${
